...
import { MagnifyingGlassIcon, FunnelIcon, ArrowRightIcon, TrophyIcon, XCircleIcon } from '@heroicons/react/24/outline';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-6 md:py-12">
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <Link
                to="/weekly-challenge"
                className="mt-2 inline-flex items-center justify-center w-10 h-10 rounded-full border border-blue-500/50 text-blue-200 hover:text-white hover:border-blue-400 transition-colors"
